...
export async function main(ns) {
    ...
    if (flags.help) {
        ns.tprint('=== hacknet-manager.js v1.1.0 ===');
        ...
        ns.tprint('Usage:   run /scripts/hacknet-manager.js [--reserve N] [--hash-target S]');
        ns.tprint('Flags:');
    ...
    ns.tprint('=== hacknet-manager.js v1.1.0 | reserve:$' + flags.reserve + ' ===');
